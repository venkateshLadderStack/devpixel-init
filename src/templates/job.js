...
const Job = ({ data }) => {
  return (
    <React.Fragment>
      <Helmet>
        <meta charSet="utf-8" />
        <title>{`${data.wordpressWpJob.title} | Devpixel`}</title>
      </Helmet>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="section-title">
                <h3>{data.wordpressWpJob.title}</h3>
                <span>{data.wordpressWpJob.acf.job_type}</span>
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col-lg-12">
              <JobDescriptionWrapper
                dangerouslySetInnerHTML={{
                  __html: data.wordpressWpJob.content,
                }}
              />
